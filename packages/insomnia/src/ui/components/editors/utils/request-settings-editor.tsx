...
export const RequestSettingsEditor = () => {
  ...
  const [state, setState] = useState<State>({
    defaultPreviewMode: !!activeRequest,
  ...
  async function handleMoveToWorkspace() {
    ...
    navigate(
      `/organization/${organizationId}/project/${projectId}/workspace/${state.activeWorkspaceIdToCopyTo}/debug`
    );
  }
              ...
              <div className='form-control form-control--outlined'>
                <label>
                  ...
                  <select
                    ...
                    onChange={event => {
                      const activeWorkspaceIdToCopyTo =
              ...
              <div className='pad-top pad-bottom'>
                ...
                <div className='form-control form-control--thin'>
                  <label>
                    ...
                    />
                    <HelpTooltip position='top' className='space-left'>
                      Automatically encode special characters at send time (does
                      not apply to query parameters editor)
                    </HelpTooltip>
                  </label>
                </div>
                <div className='form-control form-control--thin'>
                  <label>
                    ...
                    />
                    <HelpTooltip position='top' className='space-left'>
                      Disable rendering of environment variables and tags for
                      the request body
                    </HelpTooltip>
                  </label>
                </div>
                <div className='form-control form-control--thin'>
                  <label>
                    ...
                    <HelpTooltip position='top' className='space-left'>
                      ...
                      "/./" that may exist in the URL's path part and that is
                      supposed to be removed according to RFC 3986 section 5.2.4
                    </HelpTooltip>
                    <input
                      type='checkbox'
                ...
                <label>
                  ...
                  <select
                    ...
                    onChange={async event => {
                      const updated = await request.update(activeRequest, {
